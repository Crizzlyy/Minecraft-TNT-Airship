...
## There are room for many improvements in the code, it's on my to-do list to update with several improvements, but feel free to improve things if you are going to use it :)
